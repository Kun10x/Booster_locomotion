...
def brax_ppo_config(
  ...
  elif env_name == "Op3HeadScan":
      rl_config.num_timesteps = 1_000_000  # 1M is plenty
      rl_config.num_envs = 1024           # Fewer environments to save memory
      rl_config.learning_rate = 5e-4       # Slightly more stable learning rate
      rl_config.reward_scaling = 1.0       # Keeping it simple
  elif env_name == "Op3Joystick":
      rl_config.num_timesteps = 200_000_000 
