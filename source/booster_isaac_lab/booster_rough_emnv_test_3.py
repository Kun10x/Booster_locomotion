...
class BoosterRewards(RewardsCfg):
    ...
    feet_air_time = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": mdp.SceneEntityCfg("contact_forces", body_names=".*_foot_link")
            if hasattr(mdp, "SceneEntityCfg")
            else None,
            "threshold": 0.4,
        },
    )
    feet_slide = RewTerm(
        ...
        weight=-0.1,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names="Ankle_Cross_(Left|Light)"),
